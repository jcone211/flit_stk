...
2. 选择项目目录下的 `assets/thswc_full_backup_20260829-231116.json`
...
- [docs/README.md](docs/README.md)——**开发期文档索引**：事故复盘（`docs/incidents/`）、技术解析（`docs/design/`）、历史归档（`docs/archive/`，含旧版完整说明）；开发约定见仓库根目录 `CLAUDE.md`。
